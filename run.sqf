...
/* ********************************************************************************* */
/*
	Default settings are for Arma3 Epoch.
	...
	when they are in the "_ForbiddenVehicles" array (This array should be working fine with Epoch).
...
_startAsNormal =
[
	'76561198018219256','76561198096317882','0'
];
/*
...
_passwordAdmin = 'Password100';
_adminLevel1_UIDs =
[
	'76561198018219256','76561198152351109','76561198093747391','76561198133661890','76561198024359523','76561198110675606','76561198094245375','76561198096317882'
];
_adminLevel1 =
[
	...
	'Remove Gear','Revive','Heal','Repair','Move In My Vehicle','Move In Target Vehicle','Move In Parachute',
	...
	'Request Steam Name *experimental*'
];
_adminLevel2_UIDs =
[
	'0','0','0'
...
/*  Use Second Var check */ _UV2 = false;	/* true or false */	/* checks vars */
/*  _UV2 content scan    */ _V2C = false;	/* true or false */	/* checks the content of vars */
/*  Use Controls Check   */ _CC2 = false;	/* true or false */	/* checks controls */
...
/*  Check CTRLs on D00   */ _C00 = false;	/* true or false */	/* will announce: BadControls count on IDD 0 or BadControl and a number */
...
/*  Check Actions Plr    */ _CAP = true;	/* true or false */	/* only logs to Surveillancelog so far */
...
/*  Use Anti Teleport    */ _UAT = true;	/* true or false */	/* _UAT = false; on AltisLife! - I need a white-list of allowed positions first! */
/*  Chat-Vote Day/Night  */ _VDN = true;	/* true or false */
/*  Check Vision Mode    */ _CVM = true;	/* true or false */
/*  Force Terrain Grid ? */ _FTG = 35;		/* 50, 25, 12.5  */	/* if set to 50 grass will be very low for better client FPS.. default is 25 ~45 is good performance and grass :) */
/*  check view distance  */ _CVD = false;	/* true or false */	/* if the viewdistance is not 1600 - ban. */
/*  check cameraOn       */ _CCO = true;	/* true or false */
/*  Revert Keybinds      */ _RKB = false;	/* true or false */	/* recommended:  true  Removes custom Keybinds and sets back the default ones */
...
/*  MouseMoving EH check */ _MOH = true;	/* true or false */	/* announces: "MouseMoving EventHandler added" - needs to be disabled for UAV scripts and such.. */
/*  MouseButton EH check */ _MBC = true;	/* true or false */	/* announces: "MouseButton EventHandler added" */
/*  check MapSingleClick */ _OMC = false;	/* true or false */	/* announces: "onMapSingleClick modified", if modification is found - NEEDS _MBC to be true! */
...
/*  check view distance  */ _CVD = true;	/* true or false */	/* if the viewdistance is not 1600 - ban. */
...
_allowedDialogs = [-1,602,9999,9980];
...
_onLoadUnload1 = [
	'RscDisplayDSinterface','RscDisplayOptionsVideo',
	'RscDisplayDebriefing','RscDisplayInventory','RscDisplayMainMap','RscDisplayGetReady','RscDisplayLoadMission','RscDisplayInterrupt',
	'RscDisplayOptions','RscDisplayAVTerminal','RscDisplayConfigureAction','RscDisplayConfigureControllers',
	...
	'RscDisplayMPInterrupt','RscDisplayRemoteMissions','RscConfigEditor_Main','RscDisplayMain',
	...
	'RscDisplayMissionEnd','RscDisplaySelectSave','RscDisplayDedicatedServer'
];
...
[
	'MixedScript.sqf','justtrolling.sqf','A3AH.sqf',
	...
	'Dta\Screens.bin','ArmA2OA_Extras\ben_ex.sqf'
];
...
[
	'arsenalOpened','BIS_fnc_arsenal_fullArsenal','infiSTAR_ADMINS','infiSTAR_MOD','n912','TBMKnlist','PLAY','ALTISLIFENEXT3',
	...
	'Sload','aKFerm','aKMMenu','aKTitans','aKLikeaG0d','riasgremory_G0d_Mode','aKCarG0d','riasgremory_Car_Jesus','aKE5p','riasgremory_isseilol','aKPMark',
	...
	'VAR56401668319_secret','myPubVar','XXMMWW_boxquad','Init_Menu_Fury','A3RANDVARrpv1tpv','fnc_nestf','XXMMWW_keybinds','smissles','wooden_velo'
];
